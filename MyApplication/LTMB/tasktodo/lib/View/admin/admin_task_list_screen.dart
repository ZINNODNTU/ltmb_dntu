...
import 'UserManagementScreen.dart'; // Import màn hình quản lý người dùng

/// Màn hình hiển thị danh sách nhiệm vụ dành cho admin
class TaskListScreenAdmin extends StatelessWidget {
  final String adminId;

  TaskListScreenAdmin({required this.adminId, Key? key}) : super(key: key);

  /// Hàm xóa nhiệm vụ khỏi Firestore
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => TaskDetailScreenAdmin(task: task),
                      ),
                    );
                  },
                ),
